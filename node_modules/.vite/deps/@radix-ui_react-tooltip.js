...
var TooltipProvider = __name10((props) => {
  const {
    __scopeTooltip,
...
var Tooltip = __name10((props) => {
  ...
  const [contentIdState, setContentId] = React11.useState(void 0);
...
var TooltipTrigger = React11.forwardRef(
  __name10(function TooltipTrigger2(props, forwardedRef) {
...
var TooltipPortal = __name10((props) => {
...
var TooltipContent = React11.forwardRef(
  __name10(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React11.forwardRef(__name10(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  ...
  React11.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name10((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name10((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React11.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name10((event) => {
        const target = event.target;
...
var TooltipContentImpl = React11.forwardRef(
  // blank line to reduce diff noise
  __name10(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
    ...
    React11.useEffect(() => {
      if (context.trigger) {
        const handleScroll = __name10((event) => {
...
var TooltipArrow = React11.forwardRef(
  __name10(function TooltipArrow2(props, forwardedRef) {
...
__name10(getExitSideFromRect, "getExitSideFromRect");
...
__name10(getPaddedExitPoints, "getPaddedExitPoints");
...
__name10(getPointsFromRect, "getPointsFromRect");
...
__name10(isPointInPolygon, "isPointInPolygon");
...
__name10(getHullPresorted, "getHullPresorted");
